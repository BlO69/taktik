...
async function pollPartyNewGameOnce() {
  ...
  try {
    ...
    // --- PATCH C: pass authoritative finalizeRow values to series modal ---
if (finalizeRow.series_winner && String(state.seriesFinishedShownForSeriesId) !== String(finalizeRow.series_id)) {
  showSeriesModal({
